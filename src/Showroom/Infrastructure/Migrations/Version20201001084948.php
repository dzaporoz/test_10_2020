...
final class Version20201001084948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_account_id INTEGER NOT NULL)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C74404553C0C9956 ON client (user_account_id)');
        $this->addSql('CREATE TABLE trade_in_deal (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_car_model_id INTEGER NOT NULL, showroom_car_model_id INTEGER DEFAULT NULL, client_id INTEGER NOT NULL, client_car_price INTEGER NOT NULL, showroom_car_price INTEGER DEFAULT NULL)');
        $this->addSql('CREATE INDEX IDX_3AC5A684474920E2 ON trade_in_deal (client_car_model_id)');
        $this->addSql('CREATE INDEX IDX_3AC5A6842983E211 ON trade_in_deal (showroom_car_model_id)');
        $this->addSql('CREATE INDEX IDX_3AC5A68419EB6921 ON trade_in_deal (client_id)');
    }
